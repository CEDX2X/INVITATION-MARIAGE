    ...
    <AnimatePresence>
      {!isDone && (
        ...
        >
          ...
          >
            {/* 1. Underlying Premium White Invitation Card (the card inside that is revealed) */}
            <motion.div
            ...
            >
              {/* Floral background textures for card paper inside */}
              ...
              {/* Eternal Love Signature exactly like base template image */}
              <div className="mb-2">
            ...
            {/* 2. Left Laser-Cut Gatefold Panel */}
            <motion.div
              style={{ originX: 0 }}
              variants={{
            ...
            >
              {/* Exquisite Laser-Cut Engraved Rose Overlay (Left wing) */}
              <div className="absolute inset-0 opacity-45 pointer-events-none p-3 flex flex-col justify-between">
                {/* SVG Leafy & Rose vines patterns traced in crimson overlay */}
                <svg className="w-full h-full text-[#DF016E] filter drop-shadow-sm" viewBox="0 0 100 200" fill="none" stroke="currentColor" strokeWidth="1.2">
                  ...
                  {/* Rose outline abstraction top left */}
                  ...
                  {/* Rose outline abstraction middle bottom */}
            ...
            {/* 3. Right Laser-Cut Gatefold Panel */}
            <motion.div
              style={{ originX: 1 }}
              variants={{
                closed: { x: 0, rotateY: 0, opacity: 1 },
            ...
            >
              {/* Exquisite Laser-Cut Engraved Rose Overlay (Right wing) */}
              <div className="absolute inset-0 opacity-45 pointer-events-none p-3 flex flex-col justify-between">
                {/* SVG Leafy & Rose vines patterns traced in crimson overlay */}
                <svg className="w-full h-full text-[#DF016E] filter drop-shadow-sm" viewBox="0 0 100 200" fill="none" stroke="currentColor" strokeWidth="1.2">
                  ...
                  {/* Rose outline abstraction top right */}
            ...
            {/* 4. Elegant 3D Oval Gold Wax Seal Component with Floral Rose Embossing */}
            <motion.div
              variants={{
            ...
            >
              ...
              >
                ...
                >
                  {/* Intricate Embossed Golden Rose Vector Outline */}
                  <svg className="w-8 h-8 text-[#58410b] filter drop-shadow-[0.5px_0.5px_0px_rgba(255,255,255,0.15)]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
                    ...
                    {/* Tiny heart detailing inside stamp */}
